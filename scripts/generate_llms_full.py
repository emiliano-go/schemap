...
SITE_URL = "https://emiliano-gandini-outeda.me/schemap"
...
def main() -> int:
    ...
    sections = [
        "# schemap Documentation",
        "> Full documentation for schemap \u2014 Automatic Pydantic schemas from SQLAlchemy models",
        f"> Source: {SITE_URL}",
